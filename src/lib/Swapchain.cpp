...
namespace ergovk
{
	void Swapchain::destroy()
	{
		if (this->m_swapchain)
		{
			this->m_depth_image_view.destroy();
			this->m_depth_image.destroy();
	...
	Result<Swapchain, SwapchainCreateError> Swapchain::create(VmaAllocator allocator, VkPhysicalDevice physical_device,
